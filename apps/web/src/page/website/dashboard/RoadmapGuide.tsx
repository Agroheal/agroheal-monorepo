      ...
      <div className="bg-emerald-900 px-4 md:px-8 pt-8 pb-14 text-white">
        ...
        >
          ...
          <p className="text-emerald-200 mt-2 text-xs sm:text-sm md:text-base max-w-2xl leading-relaxed">
            Your comprehensive guide to agribusiness education, Wealth Creation farm slots, and projected quarterly harvest returns (AgroHeal is an agricultural community, not an investment platform).
          </p>
        </motion.div>
      </div>
