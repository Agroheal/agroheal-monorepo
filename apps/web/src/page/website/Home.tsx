...
export default function Home() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: "Each slot represents a managed production unit within a commercial community cluster (such as 2 Oyster Mushroom fruiting bags). Your contribution directly finances biological inputs and infrastructure with zero recurring monthly fees. We are an agricultural community, not an investment platform; members participate in actual biological production sold through established off-taker channels.",
    },
    {
