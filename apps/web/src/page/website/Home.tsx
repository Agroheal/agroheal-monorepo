        ...
        <div className="container mx-auto px-6 max-w-7xl relative z-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
            {[
              ...
              {
                title: "Gingertown",
                subtitle: "Premium Organic Ginger Production for Export",
                description:
                  "How it Works:\n\nParticipants are grouped into 1-Hectare commercial ginger clusters for high-grade organic export.\n\n1. Secure Your Green Card (₦2,000)\nOne-time ₦2,000 lifetime Green Card access to export-grade organic agronomy courses and network privileges.\n\n2. Secure Your Farm Slot\nJoin a commercial ginger farm group. Slot capital directly finances certified seed rhizomes, organic soil preparation, and drip irrigation systems.\n\n3. Professional Farm Oversight\nManaged by qualified agronomists and local farm labor. Members track real-time milestones via their online dashboard without requiring physical farm labor.\n\n4. High-Yield Export Sales\nPremium harvested ginger is cured, processed, and supplied directly to export and industrial spice markets, distributing profits directly into member wallets.",
              },
            ].map((card, index) => {
